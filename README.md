...
Security intelligence network and packet capture analytics system. Custom-tailored for police department cyber cells, forensic labs, and network auditors.
...
## 🏗️ Technical Stack (Phase 1 — Foundation)
...
**Default Credentials**:
- **Admin**: `admin` / (any password in demo mode)
- **Investigator**: `investigator` / (any password in demo mode)
- **Viewer**: `viewer` / (any password in demo mode)
